...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-photo-session' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-photo-session' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-photo-session' ),
		'repeat'    => __( 'Repeat All', 'skt-photo-session' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-photo-session' ),
		'top center'    => __( 'Top Center', 'skt-photo-session' ),
		'top right'     => __( 'Top Right', 'skt-photo-session' ),
		'center left'   => __( 'Middle Left', 'skt-photo-session' ),
		'center center' => __( 'Middle Center', 'skt-photo-session' ),
		'center right'  => __( 'Middle Right', 'skt-photo-session' ),
		'bottom left'   => __( 'Bottom Left', 'skt-photo-session' ),
		'bottom center' => __( 'Bottom Center', 'skt-photo-session' ),
		'bottom right'  => __( 'Bottom Right', 'skt-photo-session')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-photo-session' ),
		'fixed'  => __( 'Fixed in Place', 'skt-photo-session')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-photo-session' ),
		'italic'      => __( 'Italic', 'skt-photo-session' ),
		'bold'        => __( 'Bold', 'skt-photo-session' ),
		'bold italic' => __( 'Bold Italic', 'skt-photo-session' )
		);
