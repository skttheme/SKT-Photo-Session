...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'id' => 'footertext2',
		'std' => 'Photo Session 2023. All Rights Reserved',
		'type' => 'text');
	...
	$options[] = array(
		...
		'type' => 'info');	
	$options[] = array(
		'desc' => '<a href="'.esc_url(SKT_THEME_URL).'" target="_blank"><img src="'.get_template_directory_uri().'/images/sktskill.jpg"></a><p><em><a target="_blank" href="'.esc_url(SKT_THEME_URL_DIRECT).'">'.__('Buy PRO version for only $39 with more features.','skt-photo-session').'</a></em></p>',
		'type' => 'info');			
