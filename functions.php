...
function skt_photo_session_scripts() {
	...
	wp_enqueue_style( 'skt-photo-session-shutter-style', get_template_directory_uri()."/css/shutter.css" );
	
	wp_enqueue_script( 'skt-photo-session-shutter-min-slider', get_template_directory_uri() . '/js/shutter.min.js', array('jquery') );
	
	wp_enqueue_script( 'skt_photo_session-shutter', get_template_directory_uri() . '/js/shutter.js', array('jquery') );
...
define('SKT_THEME_URL_DIRECT','https://www.sktthemes.org/shop/skt_photo_session_pro/');
define('SKT_THEME_URL','https://www.sktthemes.org/themes/');
define('SKT_URL', 'https://www.sktthemes.org' );
define('SKT_DOC_URL', 'https://sktthemesdemo.net/documentation/photo-session-documentation/');
